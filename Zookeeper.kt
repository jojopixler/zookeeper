...
fun main() {
  ...
  while (userSelection != "exit") {
    print("Please enter the number of the habitat you would like to view (1 - 6), or type \"exit\" to exit: ")
    userSelection = readln()
    if (userSelection != "exit") println(animals[userSelection.toInt() - 1])
  }
